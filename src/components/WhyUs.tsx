            ...
            <div className="container relative z-10 max-w-[1200px] mx-auto px-4">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {reasons.map((reason, index) => (
                        <div key={index} className="group text-center p-8 rounded-[2rem] bg-white/70 backdrop-blur-md border border-white/40 shadow-card hover:shadow-card-hover hover:bg-white transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="mt-24 max-w-4xl mx-auto text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 text-left bg-white/60 backdrop-blur-xl rounded-[2.5rem] p-10 border border-white/40 shadow-lg">
